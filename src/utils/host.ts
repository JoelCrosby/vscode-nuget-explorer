...
export function showPickerView<T extends PickerViewItem>(items: T[], canPickManay: boolean, placeholder: string) {
  return vscode.window.showQuickPick<T>(items, { canPickMany: true, placeHolder: placeholder });
}
